...
class PluginHelloWorld extends PolymerElement {
    ...
    static get template() {
        return html`
            ...
            <pebble-textbox value="And...hello from pebble-textbox">
            </pebble-textbox>`;
    }
    ...
    static get properties() {
        return {
            label: {
                type: String,
                value: "Hello world from the first ever Riversand DataPlatform UI plugin!!"
            },
            message: {
                type: String,
                value: ""
    ...
    async connectedCallback() {
        ...
        if (ObjectUtils.isValidObjectPath(configResponse, "response.status") && configResponse.response.status == "success") {
